  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-gold/20 bg-xuan-card/97 backdrop-blur-md md:hidden">
      <div className="grid grid-cols-6 px-1 pb-[max(env(safe-area-inset-bottom),0.5rem)] pt-2">
        <a className={`flex flex-col items-center gap-0.5 rounded-md px-0 py-2 text-xs transition-colors duration-fast ${isActive('home') ? 'text-gold' : 'text-ink-muted'}`} href="/">
        ...
        <a className={`flex flex-col items-center gap-0.5 rounded-md px-0 py-2 text-xs transition-colors duration-fast ${isActive('qifu') ? 'text-gold' : 'text-ink-muted'}`} href="/qifu/">
        ...
        <a className={`flex flex-col items-center gap-0.5 rounded-md px-0 py-2 text-xs transition-colors duration-fast ${isActive('almanac') ? 'text-gold' : 'text-ink-muted'}`} href="/almanac/">
        ...
        <a className={`flex flex-col items-center gap-0.5 rounded-md px-0 py-2 text-xs transition-colors duration-fast ${isActive('lottery') ? 'text-gold' : 'text-ink-muted'}`} href="/lottery/">
        ...
        <a className={`flex flex-col items-center gap-0.5 rounded-md px-0 py-2 text-xs transition-colors duration-fast ${isActive('more') ? 'text-gold' : 'text-ink-muted'}`} href="/more/">
