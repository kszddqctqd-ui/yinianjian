  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      <svg className="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* 极小的金色光点装饰 */}
        {[
          [25, 30, 0.4, 0.10], [40, 50, 0.5, 0.12], [70, 20, 0.3, 0.08], [55, 40, 0.45, 0.11], [15, 65, 0.35, 0.09],
          [80, 55, 0.5, 0.13], [35, 70, 0.4, 0.10], [65, 85, 0.3, 0.08], [48, 10, 0.5, 0.12], [92, 35, 0.35, 0.09],
        ].map(([cx, cy, r, op], i) => (
          <circle
            key={i}
            cx={`${cx}%`}
